...
function anchorPanels() {
	...
	if ($('#view-box')[0] && $('#view')[0])  {
        $('#view-box').css('left', ($('#view').position().left + $('#view').width() + $('#toolbar').position().left + 5));
        $('#view-box').css('top', ($('#view').position().top + $('#toolbar').position().top));
    }
	
	if ($('#color-box')[0] && $('#color')[0]) {
        $('#color-box').css('left', ($('#color').position().left + $('#color').width() + $('#toolbar').position().left + 5));
        $('#color-box').css('top', ($('#color').position().top + $('#toolbar').position().top));
    }
	
	if ($('#solidcolor-box')[0] && $('#solidcolor')[0]) {
		$('#solidcolor-box').css('left', ($('#solidcolor').position().left + $('#solidcolor').width() + $('#toolbar').position().left + 5));
		$('#solidcolor-box').css('top', ($('#solidcolor').position().top + $('#toolbar').position().top));
	}
	
	if ($('#data-box')[0] && $('#data')[0]) {
		$('#data-box').css('top', ($('#data').position().top  + $('#dataset200').position().top) + 40);
		$('#data-box').css('left', ($('#data').position().left + $('#dataset200').position().left));
	}
}
